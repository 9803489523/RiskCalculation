        ...
        <div class="wrapper">
            <div class="grid">
                ...
                <div class="part capec">
                    <a target="_blank" :href="'/capecs/' + props.capec?.capecId">
                ...
                <div v-if="bdu !== null" class="part bdu_cve">
                    <a :href="'/cves/'+props.cve?.cveId" target="_blank" rel="noopener noreferrer">
                ...
                <div v-else class="part cve">
                    ...
                    <div class="subtitle">
                        <h3>Наменование уязвимости</h3>
                        <p v-if="bdu?.vulnerabilityName">{{ bdu?.vulnerabilityName }}</p>
                        <p v-else>{{ props.cve?.cisaVulnerabilityName }}</p>
                    </div>
                    <div class="subtitle">
                        <h3>Описание уязвимости</h3>
                        <p v-if="bdu?.vulnerabilityDescription"><span>Описание: </span>{{ bdu?.vulnerabilityDescription }}
                        </p>
                        <p v-else><span>Описание: </span>{{ parse(props.cve?.descriptions)[0].value }}</p>
