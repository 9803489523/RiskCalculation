<template>
    <div class="table">
        <h5 style="display: flex; justify-content: space-between;">Схемы атак по поиску
                        ...
                        <template v-for="capec in cve?.capec_list">
                            <tbody v-if="isShown(cve)">
                                <tr>
                                    ...
                                    <td>
                                        <p v-for="Mitigation in capec.capec_info?.mitigations">{{ Mitigation }}
                                        </p>
                                    </td>
                                    <td>
...
export default defineComponent({
    ...
    methods: {
        ...
        isShown(cve) {
            let count = 0
            this.cve_id_list.forEach(cve_id => {
